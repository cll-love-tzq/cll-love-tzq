...
var wi = new Vue({
    ...
    methods:{
        ...
        timeline(top){
            let timeline_rows = Array.from(document.querySelectorAll('.timeline_row'));
            timeline_rows.forEach((t,i)=>{
          ...
          choosePic(index){
            let ctrls = Array.from(document.querySelectorAll('.gallery_ctrls'));
            let pictures = Array.from(document.querySelectorAll('.photos'));
            ctrls.forEach((c,i)=>{
